...
class TaskonomyReplicaGsoDataset(data.Dataset):
    ...
    class Options():
        ...
        replica_data_path: str = '/scratch-data/ainaz/replica-taskonomized'
        gso_data_path: str = '/scratch-data/ainaz/replica-google-objects'
        hypersim_data_path: str = '/scratch-data/ainaz/hypersim-dataset2/evermotion/scenes'
        blendedMVS_data_path: str = '/scratch-data/ainaz/BlendedMVS/mvs_low_res_taskonomized'
        habitat2_data_path: str = '/scratch-data/ainaz/habitat2/'
        split: str = 'train'
    ...
    def load_datasets(self, options):
        ...
        for dataset in self.datasets:
            ...
            # old path: /datasets/home/teresa/it_refinement/omnidata/building_pkls
            if dataset == 'taskonomy':
                tmp_path = '/datasets/home/oguzhan/building_pkls/{}_{}_{}.pkl'.format(
                    dataset,
                    '-'.join(options.tasks), 
            ...
            #tmp_exists = False
            #print("I put it to refresh tmp")
            print("path to pkls ", tmp_path)
            # breakpoint()
            if tmp_exists and not self.force_refresh_tmp:
                ...
                print(f'Loaded {dataset} with {dataset_size} images from pkls.')
    ...
    def __init__(self, options: Options):
        ...
        print("rgb len : ", len(self.urls['rgb']))
        ...
        for task in self.tasks:
            ...
            for url in self.urls[task]:
                ...
                if building in ['almena','albertville','wiconisco','rough']: continue # something wrong with edge texture
        ...
        # if url.__contains__('replica_gso'): breakpoint()
    ...
    def __getitem__(self, index):
        ...
        for task_num, task in enumerate(self.tasks):
            ...
            jitter = bool(random.getrandbits(1)) if task in ['rgb'] else False
            ...
            for v in positive_views:
                ...
                res = self.default_loader_s3(path)
    ...
    def default_loader_s3(self,path):

        obj = self.s3_client.get_object(Bucket=self.bucket_name, Key=path)['Body'].read()
