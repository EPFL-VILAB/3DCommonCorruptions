...
CANNY_RGB_BLUR_SIGMA = 3.0              # 1.0:clevr, 1.0:google_scanned, 1.0:carla, 3.0:all
...
KEYPOINT_SUPPORT_SIZE = 0.3     #0.3:all , 0.3:clevr, 0.2:replica-gso, 1.0:carla

# Applies a blur after keypoint detection, radius
KEYPOINT_BLUR_RADIUS = 5

# ----Reshading-----
LAMP_ENERGY = 2.5                 #2.5:all , 10:clevr, 1.5:google_scanned, replica-gso:2
