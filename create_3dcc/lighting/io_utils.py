...
def get_file_name_for(dir, point_uuid, view_number, camera_uuid, task, ext, shot_number):
    """
    ...
    filename = "point_{0}_view_{1}_domain_{2}_{3}.{4}".format(point_uuid, view_specifier, task, shot_number, ext)
